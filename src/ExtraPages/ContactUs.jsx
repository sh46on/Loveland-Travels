...
const ContactUs = () => {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      content: <> <div style={{ whiteSpace: 'pre-line' }}> {SITE.address.line1} </div> <br />{SITE.address.line2}<br />Pin: {SITE.address.pin}</>,
    },
  ];
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-legal">
               <span className="flex gap-5">
                          <Link
                            to="/privacy-policy"
                            className="text-white/32 hover:text-white/60 transition-colors no-underline"
                          >
                            Privacy Policy
                          </Link>
